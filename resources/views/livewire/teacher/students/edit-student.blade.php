        ...
        <div class="mt-5 p-4 relative z-10 bg-white border border-gray-200 rounded-3xl shadow-2xl sm:mt-10 md:p-10 transition-transform duration-300 hover:scale-[1.01]">
            ...
            <div class="px-6 py-4 flex items-center gap-3 border-b border-gray-200 relative">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-500">Edit student information here</p>
                </div>
                <div class="ml-auto">
                    <a class="py-2 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 shadow transition" href="/student-list" wire:navigate>
                        View all
                    </a>
                </div>
            </div>
            ...
            <form wire:submit="update" class="mt-6">
                <div class="mb-6">
                    ...
                    <input type="text" wire:model="first_name" class="py-3 px-4 block w-full border-gray-300 bg-gray-50 rounded-lg text-base focus:border-blue-500 focus:ring-blue-500" placeholder="First name">
                    @error('first_name')
                ...
                <div class="mb-6">
                    ...
                    <input type="text" wire:model="last_name" class="py-3 px-4 block w-full border-gray-300 bg-gray-50 rounded-lg text-base focus:border-blue-500 focus:ring-blue-500" placeholder="Last name">
                    @error('last_name')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-6">
                    ...
                    <input type="number" wire:model="age" class="py-3 px-4 block w-full border-gray-300 bg-gray-50 rounded-lg text-base focus:border-blue-500 focus:ring-blue-500" placeholder="Enter Age">
                    @error('age')
                        <span class="text-red-500 text-sm">{{ $message }}</span>
                    @enderror
                </div>
                <div class="mb-8">
                    <label class="block mb-2 text-sm font-medium text-gray-700">Grade</label>
                    <select wire:model="grade" class="py-3 px-4 block w-full border-gray-300 bg-gray-50 rounded-lg text-base focus:border-blue-500 focus:ring-blue-500">
